  ...
  Widget build(BuildContext context) {
    ...
    return Wiredash(
      ...
      theme: WiredashThemeData(
        ...
        textOnPrimary: isDarkTheme ? Colors.white : AppColor.vulcan,
        textOnSecondary: isDarkTheme ? Colors.white : AppColor.vulcan,
        thirdPenColor: isDarkTheme ? Colors.white : AppColor.vulcan,
